...
map.addControl(layerSwitcher);
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_ADMINISTRASIDESA_AR_1,
      colName: 'NAMOBJ',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([12818953.853943, -988779.844928, 12898883.831746, -945029.656804], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        qgis2webAttribution.innerHTML = 'Made with ❤️ by Kelompok 3 SIG';
